 ...
 */
package com.openv.mybatis.mapper.example.where;
...
public class TestWhere {
	private static final Log log = LogFactory.getLog(TestWhere.class);
	public static void main(String[] args) throws IOException {
		...
		String statement ="com.openv.mybatis.mapper.example.where.selectAll";
