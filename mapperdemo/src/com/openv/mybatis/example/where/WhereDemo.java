 ...
 */
package com.openv.mybatis.example.where;
...
public class WhereDemo {
	private static final Log log = LogFactory.getLog(WhereDemo.class);
	public static void main(String[] args) throws IOException {
		...
		String statement ="com.openv.mybatis.example.where.selectAll";
