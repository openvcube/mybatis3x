...
public class SelectListDemo {
	...
	private static final Log log = LogFactory.getLog(SelectListDemo.class);
	...
	public static void main(String[] args) throws IOException {
		...
		List<Customer> customer = sqlSession.selectList(statementId,param,rowBounds);
